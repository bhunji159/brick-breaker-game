function startLevel4() {
	...
	// 보스 벽돌 이미지들 로드
	const bossBrickImages = {
		stage1: new Image(), // 체력 40~26
		stage2: new Image(), // 체력 25~11
		stage3: new Image()  // 체력 10~1
	};
	bossBrickImages.stage1.src = "assets/images/bossBrick1.png";
	bossBrickImages.stage2.src = "assets/images/bossBrick2.png";
	bossBrickImages.stage3.src = "assets/images/bossBrick3.png";
	...
	// --- 보스 이미지 선택 함수 ---
	function getBossBrickImage() {
		if (bossBrick.hitsRemaining >= 26) {
			return bossBrickImages.stage1; // coreBossBrick1.png
		} else if (bossBrick.hitsRemaining >= 11) {
			return bossBrickImages.stage2; // coreBossBrick2.png
		} else {
			return bossBrickImages.stage3; // coreBossBrick3.png
		}
	}
	...
	function drawBossBrick() {
		if (bossBrick.visible) {
			// 체력에 따라 적절한 이미지 선택
			const currentBossImage = getBossBrickImage();
			
			ctx.globalAlpha = 0.5 + (bossBrick.hitsRemaining / bossBrick.maxHits) * 0.5;
			ctx.drawImage(currentBossImage, bossBrick.x, bossBrick.y, bossBrick.width, bossBrick.height);
			ctx.globalAlpha = 1.0;
			ctx.fillStyle = 'white';
