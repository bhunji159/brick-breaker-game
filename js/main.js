...
const scenarioData = [
	...
	},
	{
		...
		message:
			"가장 먼저 내핵에 다녀온 연구팀에게 막대한 우승 상금을 수여하는 이 대회는\n 세계 지질 연구자들에게 엄청난 관심을 얻었다.",
	},
	{
		scenario: 1,
		id: 3,
	...
	},
	{
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"이런 상황에서 지구 탐사 대회 소식은 그들에게 있어 \n두번 다시 오지 않을 마지막 기회였기에 \n연구팀은 고민 없이 바로 참가를 신청했다.",
	},
	{
		scenario: 1,
		id: 5,
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"부푼 기대를 품었지만 한편으론 걱정도 많았던 연구팀은\n 우승 상금을 위해 누구보다 빨리 내핵 탐사를 끝내는 것을 목표로 탐사를 떠난다",
	},
	{
		scenario: 2,
		id: 1,
		end: 0,
		background: "assets/images/story/sc2/sc1.png",
		bgm: "assets/sounds/sc2.mp3",
		message:
			"얼마전 연구소 근처에서 발견한 이 공은\n어디서 왔는지, 어떤 물질로 되있는지도 모르는 \n 신비한 공이였다",
	},
	{
		scenario: 2,
		id: 2,
	...
	},
	{
		...
		background: "assets/images/story/sc2/sc3.png",
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"점점 깊이 내려갈 수록 측정기의 값은 심하게 요동쳤고\n연구팀은 아직까지 원인을 전혀 파악하지 못하고 있었다.",
	},
	{
		scenario: 2,
		id: 4,
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"이 이상 현상의 원인도 궁금하고\n부자가 건 상금도 탐나던 연구팀은\n더 깊은 곳으로 내려가기 위해 다시 공을 던졌다.",
	},
	{
		scenario: 3,
		id: 1,
		end: 0,
		background: "assets/images/story/sc3/sc1.png",
		bgm: "assets/sounds/sc3.mp3",
		message:
			"더 깊이 내려와 외핵층 무렵까지 도착했을 땐\n 더이상 측정기가 고장났나 싶을 정도로\n 이상한 값만을 출력하고 있었다.",
	},
	{
		scenario: 3,
		id: 2,
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"이 원인을 알수없는 상황에\n 연구팀은 궁금증을 넘어 두려움 느꼈다.",
	},
	{
		scenario: 3,
		id: 3,
		end: 0,
		background: "assets/images/story/sc3/sc2.png",
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message: "창 밖의 외핵의 상태도 무언가 기묘했다.",
	},
	{
		scenario: 3,
		id: 4,
	...
	},
	{
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"이런 해석할 수 없는 상황은 오히려 연구팀에게\n이 일의 진상을 규명하고 싶게 만들었고\n그들은 다시 공을 던지기 시작했다.",
	},
	{
		scenario: 4,
		id: 1,
		end: 0,
		background: "assets/images/story/sc4/sc1.png",
		bgm: "assets/sounds/sc4.mp3",
		message:
			"가장 깊은 곳이라고 생각되는 곳에 도착했을 때\n눈 앞에 의문의 돌덩이가 둥둥떠다니고 있었다.",
	},
	{
		scenario: 4,
		id: 2,
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"돌덩이에서부터 온갖 에너지파와 신호들이 방출되고 있는 듯 보였으며\n이를 증명하듯 측정기가 여태껏과 비교할 수 없을 정도로 날뛰었다.",
	},
	{
		scenario: 4,
		id: 3,
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"이 측정값 대로면 지구의 미래는 장담할 수 없는 상태였고\n그들은 금방 자신이 해야할 일을 알 수 있었다.",
	},
	{
		scenario: 4,
		id: 4,
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"이 돌덩이를 부수는 것이 지구를 위하는 길이라는 것을 깨달은 연구팀은\n 지구의 미래를 위해 이윽고 공을 다시 던진다",
	},
	{
		scenario: 5,
		id: 1,
		end: 0,
		background: "assets/images/story/ending/sc1.png",
		bgm: "assets/sounds/ending.mp3",
	...
	},
	{
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"계속 느껴졌던 기묘한 느낌도 사라지고 측정기도 곧 안정화된 값을 측정하기 시작하였다",
	},
	{
		scenario: 5,
		id: 3,
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"지구의 중심까지 탐험했다고는 믿을 수 없게 짧은 기간이였지만\n체감상 어마어마한 시간의 사투를 벌였던 이번 탐사는\n연구팀에게 적잖은 연구 성과를 남겨주었다.",
	},
	{
		scenario: 5,
		id: 4,
		...
		bgm: "assets/sounds/05. INTRUSION.mp3",
		message:
			"돌덩이를 부수며 지구에 안정을 가져오고\n누구보다도 빨리 최심층에 도착한 연구팀은\n이제 지상으로 올라가 상금을 받고 명예를 얻게 되었다.",
	},
];
...
function endCurrentScenario() {
	...
	console.log(
		`시나리오 ${ScenarioManager.currentScenarioNumber} 완료. 레벨을 시작합니다.`
	);
...
function returnToMainMenu() {
	...
	document.body.style.background =
		'url("assets/images/clearBG.png") no-repeat center center fixed';
